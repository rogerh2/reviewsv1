...
?>
    ...
    <div class="content left">
        <div class="wrapper">
                       ...
                       <?php $format = get_post_format();
                            ...
                            $slide_images = get_post_meta($post->ID, $prefix.'repeatable', true); ?>
                                ...
                                <div class="blog-one-content-text left">
                                    ...
                                    <div class="latest-news-text-content right">
                                        ...
                                        <div class="latest-news-text left"><div class="shortcodes"><?php the_content()?></div></div><!--/latest-news-text-->
                        ...
                        <?php }elseif($format == 'image'){ // POST FORMAT IMAGE
                            ?>
                                <?php if(!empty($image)){?>
                                <div class="blog-one-images left">
                                    <a href="<?php echo $image_full[0]?>" class="pirobox">
            ...
            <!--SIDBAR-->
            <?php tk_get_right_sidebar('Right', 'Blog')?>

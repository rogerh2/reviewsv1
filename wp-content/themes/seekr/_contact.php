            ...
            <div class="full-pages left"> 
                <div class="content-left left"> 
                    ...
                    <div class="blog-one-single left"> 
                        <div class="blog-one-images left contact-map">
                            <!--MAP-->
                            <?php
                                 ...
                                 if(empty($map_type)) {$map_type = _e('ROADMAP', tk_theme_name);}
                             ?>
                                <div class="map left">
                        ...
                        <script type="text/javascript">
                            ...
                            function checkForm(thisform)
                            {
                                with (thisform)
                                {
                                    ...
                                    if(check_field(contactmessage,"<?php echo $message_error_msg?>","<?php _e('Message',  tk_theme_name)?>")==false){
                                        error = 1;
                                    }
                                    ...
                                    if(check_field(contactname,"<?php echo $name_error_msg?>","<?php _e('Name',  tk_theme_name)?>")==false){
                                        error = 1;
                                    }

...
?>
    ...
    <div class="aside-pages left">
        <div class="home-portfolio-quote-link left">
            <img src="<?php echo get_template_directory_uri()?>/style/img/icon-portfolio-quote-link.png" title="<?php echo the_title() ?>" alt="<?php echo the_title() ?>" />
            <a href="<?php echo $link_url?>"><?php echo $link_text?></a>
        </div><!--/home-portfolio-quote-link-->

...
?> 
        ...
        <div class="aside-pages left">
            <div class="home-portfolio-quote left">
                <img src="<?php echo get_template_directory_uri()?>/style/img/icon-portfolio-quote.png" title="<?php echo the_title() ?>" alt="<?php echo the_title() ?>" />
                <span><?php echo $quote_text?></span>
            </div><!--/home-portfolio-quote-->
            <span class="quote-author"><?php echo $quote_author?></span>

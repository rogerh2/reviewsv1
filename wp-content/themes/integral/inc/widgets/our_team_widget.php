...
?>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('image_url'); ?>"><?php _e('Profile Image', 'integral'); ?></label><br />
        <small><?php _e('Square images are recommended, otherwise the border around the image will appear distored. Example: 300px height by 300px width.', 'integral'); ?></small>
